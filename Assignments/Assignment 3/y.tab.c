...
#line 1 "ass3_14CS30017.y" /* yacc.c:339  */
...
union YYSTYPE
{
#line 7 "ass3_14CS30017.y" /* yacc.c:355  */
...
static const char *const yytname[] =
{
  ...
  "val_at", "plus_plus", "minus_minus", "left_shift", "right_shift",
  "less_equal", "greater_equal", "equal_equal", "not_equal", "logical_and",
  "logical_or", "ellipses", "star_equal", "by_equal", "percent_equal",
  "plus_equal", "minus_equal", "left_shift_equal", "right_shift_equal",
  "and_equal", "bitwisenot_equal", "or_equal", "left_sq_bkt",
  "right_sq_bkt", "left_paren", "right_paren", "left_brace", "right_brace",
  "dot", "amp", "asterix", "plus", "minus", "tilde", "not", "fw_slash",
  "mod", "less_than", "more_than", "caret", "bit_or", "ter_que",
  "ter_colon", "semi_colon", "equals", "comma", "hash", "$accept",
...
#line 112 "ass3_14CS30017.y" /* yacc.c:1906  */
